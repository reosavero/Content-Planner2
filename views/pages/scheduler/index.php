...
/* ===== Dark mode ===== */
[data-theme="dark"] .scheduler-card-title { color: var(--text-primary) !important; }
[data-theme="dark"] .scheduler-date-header .task-count { color: var(--text-secondary) !important; }
[data-theme="dark"] .modal-close { color: var(--text-secondary) !important; }
[data-theme="dark"] .modal-close:hover { background: var(--surface-hover) !important; color: var(--text-primary) !important; }
[data-theme="dark"] .platform-chip { background: var(--surface) !important; border-color: var(--border) !important; color: var(--text-primary) !important; }
[data-theme="dark"] .platform-chip:hover { background: var(--surface-hover) !important; }
[data-theme="dark"] .platform-chip.checked { background: rgba(59, 130, 246, 0.18) !important; border-color: #3b82f6 !important; color: #93c5fd !important; }
